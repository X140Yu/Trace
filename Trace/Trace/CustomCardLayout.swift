...
class CustomCardLayout: UICollectionViewLayout {
    ...
    var selectIdx:Int {
        set {
            ...
            self.collectionView?.performBatchUpdates({
                ...
                //                self.collectionView?.reloadItems(at: self.collectionView!.indexPathsForVisibleItems.filter({ (indexPath) -> Bool in
    ...
    override var collectionViewContentSize: CGSize {
        ...
        get {
            ...
            return CGSize.init(width: cellSize.width, height: self.collectionView!.bounds.height)
        }
    }
    ...
    fileprivate func generateAttributeList() -> [CardLayoutAttributes] {
        ...
        for i in 0..<count {
            ...
            if selectIdx < 0 {
                ...
                attr.frame.origin.y = collectionView!.frame.size.height
            }
            if i == 0 {
                attr.frame = collectionView!.bounds
            }
    ...
    fileprivate func setNoSelect(attribute:CardLayoutAttributes) {
        ...
        var index = attribute.indexPath.row

        //        if index == 0 {
        //            attribute.frame = self.collectionView!.frame
        //            return
        //        }
        ...
        currentFrame = CGRect(x: self.collectionView!.frame.origin.x, y: self.collectionView!.frame.height -  titleHeight * CGFloat(index), width: cellSize.width, height: cellSize.height)
    ...
    fileprivate func setSelect(attribute:CardLayoutAttributes) {
        ...
        //        setNoSelect(attribute: attribute)
    }
